...
describe('get one security by email handler test', () => {
  ...
  it ('return a security success', async () => {
  ...
  it('return a security null success', async () => {
  ...
  it('return a security null error', async () => {
